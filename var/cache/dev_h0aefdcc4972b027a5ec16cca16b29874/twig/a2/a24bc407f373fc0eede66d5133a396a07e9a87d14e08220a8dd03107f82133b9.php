...
($context["product"] ?? null), "ratingAverage", [], "any", false, false, false, 71), "style" => "text-primary"]));
    ...
    public function block_component_product_box_action($context, array $blocks = [])
    {
        ...
        // line 117
        echo "                                ";
        $this->loadTemplate("@SwagPayPal/storefront/component/product/card/action.html.twig", "@Storefront/storefront/component/product/card/box-standard.html.twig", 117)->display($context);
        // line 118
        echo "                            ";
