...
class __TwigTemplate_ac39552f6eecf34c4273809e7c88eef0e5c3ce8b82f59e6ca823cb7b4c4b2f16 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_layout_header_actions_account_widget_dropdown_links($context, array $blocks = [])
    {
        ...
        echo "            <div class=\"account-menu-links\">
                ";
        // line 32
        $this->loadTemplate("@PayonePayment/storefront/page/account/sidebar.html.twig", "@Storefront/storefront/layout/header/account-menu.html.twig", 32)->display(twig_array_merge($context, ["headerWidget" => true]));
        // line 33
        echo "            </div>
        ";
    }
    ...
    {
        return new Source("", "@Storefront/storefront/layout/header/account-menu.html.twig", "/Users/kevin/Sites/kerkow_re/vendor/shopware/storefront/Resources/views/storefront/layout/header/account-menu.html.twig");
    }
}
