...
$catalogue = new MessageCatalogue('en-GB', array (
  'messages' => 
  array (
    'PayonePayment.errorMessages.genericError' => 'An error has occurred. Please try another payment method.',
    'PayonePayment.creditCard.newCard' => 'Use a new credit card',
    'PayonePayment.creditCard.cardNumber' => 'Card number',
    'PayonePayment.creditCard.securityCode' => 'Security code',
    'PayonePayment.creditCard.expiryDate' => 'Expiry date',
    'PayonePayment.creditCard.savedCards' => 'Saved card',
    'PayonePayment.creditCard.iframeError' => 'Please verify the fields and make sure no field is empty.',
    'PayonePayment.debit.accountOwner' => 'Account owner',
    'PayonePayment.debit.iban' => 'IBAN',
    'PayonePayment.debit.bic' => 'BIC',
    'PayonePayment.cardPage.menuName' => 'Credit Cards',
    'PayonePayment.cardPage.success' => 'The saved credit card was removed successfully.',
    'PayonePayment.cardPage.error' => 'An error has occurred while removing the saved credit card.',
    'PayonePayment.cardPage.pageTitle' => 'Saved Cards',
    'PayonePayment.cardPage.pageSubTitle' => 'Here you can manage your saved credit cards.',
    'PayonePayment.cardPage.tableHeader' => 'Card Numbers',
    'PayonePayment.cardPage.deleteButton' => 'Delete Card',
    'PayonePayment.cardPage.noEntries' => 'No cards saved.',
    'PayonePayment.cardPage.expired' => 'expired',
    'PayonePayment.cardPage.expiresAt' => 'expires on %expiresAt%',
    'PayonePayment.mandatePage.menuName' => 'Direct Debit Mandates',
    'PayonePayment.mandatePage.pageTitle' => 'Direct Debit Mandates',
    'PayonePayment.mandatePage.pageSubTitle' => 'Here you can manage your saved direct debit mandates.',
    'PayonePayment.mandatePage.success' => 'The saved Direct Debit Mandate was removed successfully.',
    'PayonePayment.mandatePage.error' => 'An error has occurred.',
    'PayonePayment.mandatePage.tableIdentification' => 'Nummer',
    'PayonePayment.mandatePage.tableSignatureDate' => 'Date',
    'PayonePayment.mandatePage.downloadButton' => 'Download Mandate',
    'PayonePayment.mandatePage.noEntries' => 'No mandates saved.',
    'PayonePayment.checkoutConfirmPage.defaultCardTitle' => 'Payment Information',
    'PayonePayment.checkoutFinishPage.mandateIdentification' => 'Direct Debit Mandate',
    'PayonePayment.mandateModal.question' => 'I accept the direct debit mandate',
    'PayonePayment.mandateModal.cancel' => 'Cancel',
    'PayonePayment.mandateModal.confirm' => 'Submit',
    'PayonePayment.paypalExpress.buttonTitle' => 'PayPal Express',
    'PayonePayment.paypalExpress.buttonImage' => 'checkout-logo-medium-en.png',
    'PayonePayment.paypalExpress.buttonImage2x' => 'checkout-logo-medium-en-2x.png',
    'PayonePayment.payolution.cardTitleInvoicing' => 'Paysafe Pay Later Invoice',
    'PayonePayment.payolution.cardTitleInstallment' => 'Paysafe Pay Later Installment',
    'PayonePayment.payolution.cardTitleDebit' => 'Paysafe Pay Later Debit',
    'PayonePayment.payolution.birthday.label' => 'Date of birth',
    'PayonePayment.payolution.accountHolder.label' => 'Account Holder',
    'PayonePayment.payolution.iban.label' => 'IBAN',
    'PayonePayment.payolution.bic.label' => 'BIC',
    'PayonePayment.payolution.installment.step1' => '1. Check Installment availability',
    'PayonePayment.payolution.installment.step2' => '2. Installment selection',
    'PayonePayment.payolution.installment.step3' => '3. Overview and Account Information',
    'PayonePayment.payolution.installment.checkAvailabilityButton' => 'Check Installment availability',
    'PayonePayment.payolution.installment.downloadButton' => 'Download Installment Draft',
    'PayonePayment.payolution.installment.select' => '%amount% per month - %duration% installments',
    'PayonePayment.payolution.installment.selectInstallmentsLabel' => 'Please select number of installments',
    'PayonePayment.payolution.installment.info' => '%index%. installment: %amount% (due %date%)',
    'PayonePayment.payolution.installment.numberOfInstallments' => 'No. of installments:',
    'PayonePayment.payolution.installment.financingAmount' => 'Financingamount:',
    'PayonePayment.payolution.installment.total' => 'Total:',
    'PayonePayment.payolution.installment.interestRate' => 'Nominal interest:',
    'PayonePayment.payolution.installment.effectiveInterestRate' => 'Effective interest:',
    'PayonePayment.payolution.installment.monthlyInstallment' => 'Monthly rate:',
    'PayonePayment.payolution.installment.accountOwner' => 'Account owner',
    'PayonePayment.payolution.installment.iban' => 'IBAN',
    'PayonePayment.payolution.installment.bic' => 'BIC',
    'PayonePayment.payolution.document.clearingReference' => 'Reference: %reference%',
    'PayonePayment.payolution.document.invoicingDescription' => 'Please transfer the outstanding amount to the following bank account:',
    'PayonePayment.payolution.document.iban' => 'IBAN: %iban%',
    'PayonePayment.payolution.document.bic' => 'BIC: %bic%',
    'PayonePayment.payolution.consentCheckbox.introduction' => 'With the transmission of the data necessary for the completion of the invoice purchase, an identity check and credit check to payolution GmbH, Am Euro Platz 2, 1120 Wien I agree.',
    'PayonePayment.payolution.consentCheckbox.textWithLink' => 'I can revoke my <a href="%link%" data-url="%link%" data-modal-class="payolution" data-toggle="modal" title="Einwilligung">consent</a>  at any time with effect for the future.',
    'PayonePayment.payolution.mandateCheckbox.textWithLink' => 'I hereby issue the <a href="%link%" target="_blank" title="Paysafe Pay Later SEPA mandate">SEPA direct debit mandate</a>.',
    'PayonePayment.eps.cardTitle' => 'EPS Online Bank',
    'PayonePayment.eps.bankGroupFieldLabel' => 'Banking group of you bank',
    'PayonePayment.ideal.cardTitle' => 'iDeal Online Bank',
    'PayonePayment.ideal.bankGroupFieldLabel' => 'Banking group of you bank',
    'error.VIOLATION::PAYONE_BIRTHDAY_NOT_VALID' => 'For this payment you must be over 18 years old.',
    'error.VIOLATION::PAYONE_INVALID_PAYMENT_METHOD' => 'The selected payment method is not available.',
  ),
  'storefront' => 
  array (
    ...
    'account.editOrderUpdateButton' => 'Confirm changes',
